...
export const DEBUG_APP_VERSION = "2.0.0";

export const LOCAL_APP_DATA = path.join(
...
export const PLUGINS_BACKUP = path.join(
  util.getVortexPath("temp"),
  path.basename(PLUGINS_TXT) + ".bak",
);
...
export const INSTALLING_REQUIREMENTS_NOTIFICATION_ID =
  "starfield-installing-requirements";
...
export const SFCUSTOM_INI_TEXT =
